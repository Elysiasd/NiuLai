...
浏览器标签页与产品品牌位一并接管：favicon 换成「牛来」朱文方印（楷体艺术字印章），标题里的产品名换成**「牛来影厅」**（会话名保留不动）；侧栏 logo 换成「牛来影厅 · 手搓版」lockup，新会话页的鲸鱼与「探索未至之境」换成低模牛头与**「牛来了 · 上映中」**。全部跟随 `niulai.theme` 开关，卸载或关闭主题即还原。
